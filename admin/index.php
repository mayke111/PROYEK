...
<head>
    ...
    <title>SMK YIS: Admin Dashboard</title>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="../yis.png" alt="logo" width="100%"></a>
            </div>
            <div class="main-menu">
                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                         ...
                                         <br>Sistem ini disusun oleh Yayasan Ibnu Sutowo
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <footer>
            <div class="footer-area">
                <p>PPDB Online by SMK YIS Martapura</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
